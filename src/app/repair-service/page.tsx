...
const repairServices = [
  ...
  { title: "PCB repair", problem: "No power, boot failure, blank display or intermittent control fault.", repair: "Board-level diagnosis and component repair before expensive module replacement." },
  { title: "Ink core repair", problem: "Pressure, viscosity, circulation, mixing or fluid-recognition faults.", repair: "Pumps, filters, valves, tubing, sensors and complete ink core assemblies." },
        ...
        <section className="section container" id="repair-capabilities">
          ...
          <div className="repairServiceGrid">
            {repairServices.map((service, index) => (
              <article id={service.title === "PCB repair" ? "pcb-repair" : service.title === "Preventive maintenance" ? "maintenance" : undefined} key={service.title}>
