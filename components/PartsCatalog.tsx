...
export default function PartsCatalog() {
  ...
  return <>
    <section className="section container" id="categories">
      ...
      <h2>Search parts</h2>
      <p>Search by part type. Add your model or part number for a compatibility check.</p>
      ...
      <a className="textLink" href="#parts-inquiry" onClick={() => choose("Other / not sure")}>Request Price →</a>
      <aside className="photoCallout" id="part-photo"><div><span className="eyebrow">Don’t know the part name?</span><h2>Send us a photo.</h2><p>Include the component, its label and your printer model.</p></div><a className="button primary" href="#parts-inquiry" onClick={() => choose("Other / not sure", true)}>Send Part Photo →</a></aside>
    </section>
