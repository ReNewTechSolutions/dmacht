export const productionEnvironments = [
  ...
  { id: "beverage", title: "Beverage", alt: "Capped water bottles with lot identification moving along a beverage conveyor", copy: "Bottle and can coding. Breakdown repair, printheads, ink-system parts, make-up solvents and replacement printers.", links: ["service", "parts", "printers"] },
